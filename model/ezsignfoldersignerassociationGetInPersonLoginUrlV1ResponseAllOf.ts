...
export class EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseAllOf {
    ...
    static getAttributeTypeMap() {
        return EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseAllOf.attributeTypeMap;
    }
}

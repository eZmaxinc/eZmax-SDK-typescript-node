...
export enum ModuleAuthenticateApiApiKeys {
    Authorization,
}
...
export class ModuleAuthenticateApi {
    ...
    public setApiKey(key: ModuleAuthenticateApiApiKeys, value: string) {
        (this.authentications as any)[ModuleAuthenticateApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async authenticateAuthenticateV2 (eSessionType: 'ezsignuser', authenticateAuthenticateV2Request: AuthenticateAuthenticateV2Request, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AuthenticateAuthenticateV2Response;  }> {
        const localVarPath = this.basePath + '/2/module/authenticate/authenticate/ezsignuser/{eSessionType}'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(authenticateAuthenticateV2Request, "AuthenticateAuthenticateV2Request")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AuthenticateAuthenticateV2Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "AuthenticateAuthenticateV2Response");

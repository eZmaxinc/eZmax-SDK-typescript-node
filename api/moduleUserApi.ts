...
export enum ModuleUserApiApiKeys {
    Authorization,
}
...
export class ModuleUserApi {
    ...
    public setApiKey(key: ModuleUserApiApiKeys, value: string) {
        (this.authentications as any)[ModuleUserApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async userCreateEzsignuserV1 (userCreateEzsignuserV1Request: Array<UserCreateEzsignuserV1Request>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserCreateEzsignuserV1Response;  }> {
        const localVarPath = this.basePath + '/1/module/user/createezsignuser';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(userCreateEzsignuserV1Request, "Array<UserCreateEzsignuserV1Request>")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: UserCreateEzsignuserV1Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "UserCreateEzsignuserV1Response");

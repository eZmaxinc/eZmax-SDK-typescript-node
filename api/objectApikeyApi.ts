...
export enum ObjectApikeyApiApiKeys {
    Authorization,
}
...
export class ObjectApikeyApi {
    ...
    public setApiKey(key: ObjectApikeyApiApiKeys, value: string) {
        (this.authentications as any)[ObjectApikeyApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async apikeyCreateObjectV1 (apikeyCreateObjectV1Request: Array<ApikeyCreateObjectV1Request>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ApikeyCreateObjectV1Response;  }> {
        const localVarPath = this.basePath + '/1/object/apikey';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(apikeyCreateObjectV1Request, "Array<ApikeyCreateObjectV1Request>")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ApikeyCreateObjectV1Response;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ApikeyCreateObjectV1Response");

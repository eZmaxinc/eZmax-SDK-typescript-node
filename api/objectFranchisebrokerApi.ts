...
export enum ObjectFranchisebrokerApiApiKeys {
    Authorization,
}
...
export class ObjectFranchisebrokerApi {
    ...
    public setApiKey(key: ObjectFranchisebrokerApiApiKeys, value: string) {
        (this.authentications as any)[ObjectFranchisebrokerApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async franchisebrokerGetAutocompleteV1 (sSelector: 'Active' | 'All', sQuery?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CommonGetAutocompleteV1Response;  }> {
        const localVarPath = this.basePath + '/1/object/franchisebroker/getAutocomplete/{sSelector}'
